...
@interface DRFrashLayer ()<CAAnimationDelegate>
...
- (void)drawInContext:(CGContextRef)ctx {
    ...
    if (isAnimationing) {
        ...
        drawPointAtRect(ScaleSecondPoint,ctx,UIColorFromRGB_DR(0x15C2FF, 1.0).CGColor);
            ...
            if (self.complete > 0.425 && self.complete < 0.575) {
                ...
                if (self.complete > 0.625 && self.complete < 0.775) {
                    ...
                    if (self.complete<0.7) {
                        ...
                        drawLineInContextFromStartPointAndEndPointWithScale(ctx, secondPoint, fourthPoint, scale,UIColorFromRGB_DR(0x00FFD5, 1));
                    }
                }
            }
        }
