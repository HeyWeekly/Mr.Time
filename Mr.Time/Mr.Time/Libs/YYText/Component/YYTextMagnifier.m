...
#define kRadius 6.0
#define kTextHeight 32.0
#define kArrow 14.0

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    _contentView = [UIImageView new];
    _contentView.frame = CGRectMake(kPadding, kPadding, kSize.width - 2 * kPadding, kTextHeight);
...
- (CGSize)snapshotSize {
    ...
    size.height = floor(kTextHeight / kMultiple);
    return size;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathAddLineToPoint(path, NULL, size.width - kPadding, kTextHeight);
        CGPathAddCurveToPoint(path, NULL, size.width - kPadding, kPadding + kTextHeight, size.width - kPadding - kRadius, kPadding + kTextHeight, size.width - kPadding - kRadius, kPadding + kTextHeight);
        CGPathAddLineToPoint(path, NULL, size.width / 2 + kArrow, kPadding + kTextHeight);
        CGPathAddLineToPoint(path, NULL, size.width / 2, kPadding + kTextHeight + kArrow);
        CGPathAddLineToPoint(path, NULL, size.width / 2 - kArrow, kPadding + kTextHeight);
        CGPathAddLineToPoint(path, NULL, kPadding + kRadius, kPadding + kTextHeight);
        CGPathAddQuadCurveToPoint(path, NULL, kPadding, kPadding + kTextHeight, kPadding, kTextHeight);
        ...
        CGPathMoveToPoint(arrowPath, NULL, size.width / 2 - kArrow, YYTextCGFloatPixelFloor(kPadding) + kTextHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2 + kArrow, YYTextCGFloatPixelFloor(kPadding) + kTextHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2, kPadding + kTextHeight + kArrow);
